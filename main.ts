    ...
    if (!(Main_Menu)) {
        if (Herm.vx == 0 && !(shelled)) {
            if (direction == "right") {
                ...
                music.play(music.createSoundEffect(WaveShape.Noise, 1205, 1, 255, 0, 500, SoundExpressionEffect.Vibrato, InterpolationCurve.Logarithmic), music.PlaybackMode.UntilDone)
                Herm.setImage(img`
                    . . . c c . . . . . . . . . . . 
                    . . c 3 6 c c c c . . . . . . . 
                    . . c 6 3 3 3 3 6 c . . . . . . 
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile8`, function (sprite, location) {
    for (let value6 of sprites.allOfKind(SpriteKind.Key)) {
        if (value6.vx != 0) {
            sprites.destroy(value6, effects.halo, 100)
        }
    }
